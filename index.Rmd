...
这是一个用**Markdown**编写的 _示例_ 书籍。您可以使用Pandoc的Markdown支持的任何内容；例如，数学方程式 $a^2 + b^2 = c^2$。
...
当然你也可以下载别的$TeX$发行版，比如[TeXLive](https://tug.org/texlive/)和[MaCTeX](https://tug.org/mactex/)。
